...
<head>
    ...
    <title>Stylists -Olivea Salon </title>
...
<?php endif; ?>
      ...
      <!--headline-->
      <div class="bg-image" >
        <img src="Images/stylists.jpg" class="w-100"  />
            <div  style="background-color: rgba(10, 10, 10, 0.589)">
            <h1 class="headline" >STYLISTS</h1>
            </div>
      </div>
      <!--Scroll arrow-->
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="thumbnail">
                ...
                <img class="homeimgs" src="Images/Lindsay_McEvoy.webp" style="width:100%">
                <div class="caption">
                  <h3 class="stylists-name">Lindsay Toutain</h3>
                  <p>Stylist & Colorist</p>
                </div>
          ...
          <div class="col-md-4">
            <div class="thumbnail">
                ...
                <img class="homeimgs" src="Images/Ethan.webp" style="width:100%">
                <div class="caption">
                    <h3 class="stylists-name">Ethan Silver</h3>

                  <p>Junior Stylist & Colorist</p>
                </div>
          ...
          <div class="col-md-4">
            <div class="thumbnail">
                ...
                <img class="homeimgs" src="Images/Jae.webp" alt="Fjords" style="width:100%">
                <div class="caption">
                    <h3 class="stylists-name">J Correa</h3>
      ...
      <div class="container" style="margin-top: 20px; margin-bottom: 30px;" >
        <h1 class="text-center" style="font-family: 'Gendisa Demo'; color: aliceblue;margin-top: 60px;">Meet The Team</h1> 
  
        <div class="row" style="margin-top: 60px ;margin-bottom: 60PX; ">
          <div class="col-md-4">
            <div class="thumbnail">
             
                <img class="homeimgs" src="Images/Ryan.webp" style="width:100%">
                <div class="caption">
                  <h3 class="stylists-name">Ryan O Sullivan</h3>
                  <p>Owner</p>
                </div>
          ...
          <div class="col-md-4">
            <div class="thumbnail">
                ...
                <img class="homeimgs" src="Images/Hannah.webp" style="width:100%">
                <div class="caption">
                    <h3 class="stylists-name">Hannah Brown</h3>
          ...
          <div class="col-md-4">
            <div class="thumbnail">
                ...
                <img class="homeimgs" src="Images/Molly.webp" alt="Fjords" style="width:100%">
                <div class="caption">
                    <h3 class="stylists-name">Molly Tapper</h3>
    ...
    <!--Footer-->
    <div class="container-fluid pb-0 mb-0 justify-content-center text-light " style="margin-top: -5vh;">
      <footer >
